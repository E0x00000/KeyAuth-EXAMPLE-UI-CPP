...
#include "SDK/Libraries/ImGui/backends/imgui_impl_win32.h"
#include "SDK/Libraries/ImGui/backends/imgui_impl_dx11.h"
#include "UI/UI.h"
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, (L"imgui base by REVRBE"), NULL };
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, (L"imgui base by REVRBE"), WS_POPUP | CW_USEDEFAULT, 0, 0, g_UISetup.vWindowSize.x, g_UISetup.vWindowSize.y, NULL, NULL, wc.hInstance, NULL);
    ...
    int windowWidth = g_UISetup.vWindowSize.x;
    int windowHeight = g_UISetup.vWindowSize.y;
